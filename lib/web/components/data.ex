  ...
  def table(assigns) do
    ...
    <table role="table" class={["w-full table-fixed", @class]}>
      <thead class={["text-left text-[0.8125rem] text-zinc-300 pt-4 bg-zinc-800", @sticky && "sticky top-14 z-10"]} role="rowgroup">
        <tr role="row">
          <th class="hidden w-8 truncate md:table-cell" role="columnheader" />
          <th
            :for={col <- @col}
            role="columnheader"
            class={[
          ...
          <th :if={@action != []} class="relative hidden w-24 py-2 truncate md:table-cell" role="columnheader">
      ...
      >
        ...
        >
          ...
          <td :if={@action != []} class="hidden w-24 md:table-cell" role="cell" class="relative px-3">
